...
function Worker(nodeId, serviceFactory, configService) {
    ...
    function createClientPort(config) {
        ...
        clientPort.setAuthTimeout(config.authenticationTimeOut);
    ...
    function validateConfig(config) {
        ...
        if (config.authenticationTimeOut === undefined) {
            throw "authenticationTimeOut not defined";
        }
        if (config.removeUserAfterDisconnectTimeOut === undefined) {
            throw "removeUserAfterDisconnectTimeOut not defined";
        }
