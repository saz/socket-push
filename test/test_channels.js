...
exports["test getsubscribers"] = function (test) {
    test.deepEqual(['channelId1', 'channelId2', 'channelId3'], channels.getSubscriptions('subscriberId1'));

    test.done();
}

exports["test getsubscriptions"] = function (test) {
    test.deepEqual(['subscriberId1', 'subscriberId2'], channels.getSubscribers('channelId1'));
